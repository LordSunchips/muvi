...
enum AppConfig {
    ...
    /// Change this to your Render.com URL (or wherever the backend lives) before shipping to a
    /// device. Keep `http://127.0.0.1:8000` for simulator-vs-Mac dev.
    #if DEBUG
    private static let defaultBaseURL = "http://127.0.0.1:8000"
    #else
    private static let defaultBaseURL = "https://muvi-backend.onrender.com"
    #endif
}
